...
resource "azurerm_virtual_machine" "test" {
  ...
  network_interface_ids = ["/subscriptions/eb986b09-9743-4aa1-b10f-53da04d8708c/resourceGroups/my-first-rg/providers/Microsoft.Network/networkInterfaces/terraform-testing"]
